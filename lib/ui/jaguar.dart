...
class DemoBluetooth extends StatefulWidget {
  DemoBluetooth({var decode,loadData? data,bool receiptTitleData = false,String? assets='',String? loanAmount='',String loanId=''}){
    decodeMap = decode;
    Assets = assets;
  ...
  @override
  State<DemoBluetooth> createState() => _DemoBluetoothState();
}

class _DemoBluetoothState extends State<DemoBluetooth> {
                                              ...
                                              child: Text('Ok'),
                                                ...
                                                if(bluetoothDevice!=null){
                                                  ...
                                                  Get.snackbar('',
                                                      ...
                                                      Colors.blue);
                                                  printwithBluetoothPrinter(loanMap: decodeMap,userData: decodedData,balancejsonData: jsonData,AppUserName: authManager.getUserName(),RNo: receipt_detailController.receiptMaxResponse.code.toString());

                                                printwithBluetoothPrinter(loanMap: decodeMap,userData: decodedData,balancejsonData: jsonData,AppUserName: authManager.getUserName(),RNo: receipt_detailController.receiptMaxResponse.code.toString(),device: bluetoothDevice);
                                                //printWithDevice(bluetoothDevice);
                                                }else{
                                                Get.snackbar('',
                    ...
                    onTap: (){
                      ...
                      if(decodeMap!=null) {
                        if(receipt_detailController.totalAmount>0){
                          ...
                          //  narration = textFieldNarration.text;
                          //  balance = receipt_detailController.totalAccountBalance;
                          //  var totalAmount = receipt_detailController.totalAmount;
                          //  var chqno = check.text;
                          //  var chqdate = checkDate;
                          //  var install = receipt_detailController.installmentData;
...
*//*
  ...
  printwithBluetoothPrinter({loanMap,userData,balancejsonData,String? AppUserName,String? RNo,BluetoothDevice? device}) async {
    final gen = Generator(PaperSize.mm58, await CapabilityProfile.load());
