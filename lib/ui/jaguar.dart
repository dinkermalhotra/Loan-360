...
class Jaguar extends StatefulWidget {
  const Jaguar({Key? key}) : super(key: key);
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: Text("COMPANY",style: textStyle.RegularBold.copyWith(color: AppColor.GreyColor)),
                      ),
                ...
                children: [
                  Row(
                    children: [
                      Container(
                        alignment: Alignment.topLeft,
                        child: Text("FINANCIAL YEAR",style: textStyle.RegularBold.copyWith(color: AppColor.GreyColor)),
                      ),
